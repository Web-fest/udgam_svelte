...
<div class="lead-group">
  <h3 class="section-title">Guest Receiving Leads</h3>
  <div class="team-leads">
    {#each teamLeads.guestReceiving as lead}
      <MemberCard
        name={lead.name}
        role={lead.role}
        image={lead.image}
